    ...
    <section className="py-20 sm:py-28 bg-white border-b border-slate-200/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch mb-6">
          ...
          <div className="lg:col-span-7 bg-[#FAF9F6] rounded-3xl p-6 sm:p-9 border border-slate-200/90 flex flex-col justify-between shadow-xs">
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
                ...
                <div className="bg-white rounded-2xl p-3.5 border border-slate-200/80 shadow-xs flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      <span className="text-xs font-bold text-slate-900 block truncate">Instagram Business</span>
                      <span className="text-[10px] text-slate-500">Official Graph Token</span>
                    </div>
                  </div>
                  <span className="text-[10px] font-mono text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200 shrink-0">
                    Encrypted
                ...
                <div className="bg-white rounded-2xl p-3.5 border border-slate-200/80 shadow-xs flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      <span className="text-xs font-bold text-slate-900 block truncate">Facebook Pages</span>
                      <span className="text-[10px] text-slate-500">Granular Permissions</span>
                    </div>
                  </div>
                  <span className="text-[10px] font-mono text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200 shrink-0">
                    Encrypted
                ...
                <div className="bg-white rounded-2xl p-3.5 border border-slate-200/80 shadow-xs flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      <span className="text-xs font-bold text-slate-900 block truncate">Search Console</span>
            ...
            <div className="pt-4 border-t border-slate-200/80 text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
              We never ask for or store your social or Google passwords. Secure OAuth 2.0 cryptographic token handshakes ensure private, scoped permissions that you can disconnect at any moment with 1 click.
            </div>
          </div>

          {/* Card 2 (Right 5 Cols): Air-Gapped Single-Tenant Data Isolation */}
          <div className="lg:col-span-5 bg-[#FAF9F6] rounded-3xl p-6 sm:p-9 border border-slate-200/90 flex flex-col justify-between shadow-xs">
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-slate-200/80 mb-6">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-normal">100% Single-tenant tenant privacy</p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-3xl bg-[#FAF9F6] border border-slate-200/90 shadow-xs flex flex-col justify-between">
